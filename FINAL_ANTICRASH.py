...
if __name__ == '__main__':
    print('[SYSTEM] Initializing Safe-Tensor Execution...')
    ...
    model.train(
        ...
        batch=16,          # 稳健显存调度
        device=0, 
        project='D:/medical/ablation_runs', 
        name='Final_DCN_100e_AntiCrash', 
        amp=False,         # 【核心改动】关闭混合精度，使用标准 FP32，免疫 C++ 类型冲突
        workers=0
    )
